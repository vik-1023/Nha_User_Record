...
public class dbcon {
    ...
    public int setUpdate(String updateSql, String username, String password, String chatId, String email, String status, String userType, String clients, String links, int id) {
